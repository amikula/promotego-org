...
describe "/locations/index" do
  ...
  before(:each) do
    ...
    @location_98.should_receive(:street_address).at_least(:once).and_return("StreetAddress1")
    ...
    @location_99.should_receive(:street_address).at_least(:once).and_return("StreetAddress2")
