...
describe AffiliationsController do
  describe "route generation" do
    ...
    it "should map #show" do
      route_for(:controller => "affiliations", :action => "show", :id => 1).should == "/affiliations/1"
    end
  
    it "should map #edit" do
      route_for(:controller => "affiliations", :action => "edit", :id => 1).should == "/affiliations/1/edit"
    end
  
    it "should map #update" do
      route_for(:controller => "affiliations", :action => "update", :id => 1).should == "/affiliations/1"
    end
  
    it "should map #destroy" do
      route_for(:controller => "affiliations", :action => "destroy", :id => 1).should == "/affiliations/1"
    end
  end
